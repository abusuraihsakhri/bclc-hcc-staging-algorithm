"""
Automated Pytest for bclc-hcc-staging-algorithm Enrichment Modules.
"""
import sys
...
from enrichment import (
    EnrichmentmdEngine,
    LongitudinalBclcTrackingEngine,
    ...
    BclchccstagingalgorithmEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = BclchccstagingalgorithmEnrichmentSuite()
